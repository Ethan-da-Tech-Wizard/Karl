...
SWARM_ARCHITECT_SYSTEM_PROMPT = (
    ...
    "IMPORTANT: Any GUI, plotting, or simulation code MUST run headlessly. For graphics, "
    "use matplotlib with the headless 'Agg' backend (i.e. add `import matplotlib; matplotlib.use('Agg')`) "
    "or write console/ASCII-based output. Do NOT attempt to open interactive windows (like Pygame or standard plt.show()) "
    "as they will fail in a headless environment.\n\n"
